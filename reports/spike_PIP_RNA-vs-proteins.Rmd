---
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file ='PIP_spike-proteins_all-plus-GISAID.html') })
...
knitr::opts_chunk$set(
  fig.path = paste0('figures/spike-protein_PIP/', collection, '_'))

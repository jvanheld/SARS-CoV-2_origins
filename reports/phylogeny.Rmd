...
genomeTree <- loadTree(
  file = genomeTreeFile, 
  outgroup = outgroup, rootNode = NULL, 
  rotateNodes = c(39, 75))
...
cladelabels(genomeTree$tree, "MERS", 43, cex = 0.7, orientation = "horizontal", offset = 3)
cladelabels(genomeTree$tree, "SARS", 69, cex = 0.7, orientation = "horizontal", offset = 3)

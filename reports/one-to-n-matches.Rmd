...
features[['RBD']] <- c(start = 22517, end = 23185, isCDS = FALSE)

## Recombinant region inside the RBD
features[['RBD-rec']] <- c(start = 22760, end = 23160, isCDS = FALSE)
...
features[['Recomb-reg-1']] <- c(start = 21500, end = 22800, isCDS = FALSE)
## Recombinant region 2 seen on the PIP profiles
features[['Recomb-reg-2']] <- c(start = 22800, end = 24000, isCDS = FALSE)
## Recombinant region 3 seen on the PIP profiles
features[['Recomb-reg-3']] <- c(start = 27800, end = 28350, isCDS = FALSE)
...
for (featureName in row.names(featureTable)) {
  if (featureTable[featureName, "isCDS"]) {
    ...
    featureResult <- allFeatureAlignments[[featureName]]
    rawSequences <- DNAStringSet(featureResult$sequences)
    class(rawSequences)

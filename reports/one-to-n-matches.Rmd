---
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file ='one-to-n-matches_selected-plus-GISAID.html') })
...
knitr::opts_chunk$set(fig.path = paste0('figures/one-to-n-matches_', collection, '/'))
